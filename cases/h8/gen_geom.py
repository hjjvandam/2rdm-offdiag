...
The fifth to eigth atom is placed within -5 to +5 A from the first along the z-axis
          and from -5 to +5 A along the y-axis
...
for ii in range(1000):
    ...
    z7 = random.uniform(-5.0,5.0)
    y7 = random.uniform(-5.0,5.0)
    x7 = random.uniform(-5.0,5.0)
    z8 = random.uniform(-5.0,5.0)
    y8 = random.uniform(-5.0,5.0)
    x8 = random.uniform(-5.0,5.0)
    with open(f"h8-{ii:04d}.xyz","w") as fp:
        fp.write("8\n\n")
        fp.write("h 0 0 0\n")
        fp.write(f"h 0 0 {z2}\n")
        ...
        fp.write(f"h {x7} {y7} {z7}\n")
        fp.write(f"h {x8} {y8} {z8}\n")
