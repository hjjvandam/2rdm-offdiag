...
![alpha-alpha diagonal elements](./h6_12.0-6-31g_aa_d.png)
The values of the elements are limited by the same lines
as for the H4 case.

For the alpha-beta pairs we have
![alpha-beta diagonal elements](./h6_12.0-6-31g_ab_d.png)
...
this line. Nevertheless, it is interesting that this line seems
to become more prominent here.

For the off-diagonal elements we have
![alpha-beta diagonal elements](./h6_12.0-6-31g_ab_o.png)
